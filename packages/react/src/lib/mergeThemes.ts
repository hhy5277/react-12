 ...
 */
export const mergeComponentStyles = perf.time(
 ...
 */
export const mergeComponentVariables = perf.time(
 ...
 */
export const mergeSiteVariables = perf.time(
  'mergeSiteVariables',
  (
...
export const mergeThemeVariables = perf.time(
  'mergeThemeVariables',
  (
 ...
 */
export const mergeThemeStyles = perf.time(
  'mergeThemeStyles',
  (
...
export const mergeStyles = perf.time('mergeStyles', (...sources: ComponentSlotStyle[]) => {
  return (...args) => {
    return sources.reduce((acc, next) => {
